...
- NAS should only consume power when it is required (electricity is expensive here) (make use of acpiconf)
- Prevent data loss (through regular monitoring)
- Be able to go back to a previous version of the data if needed

All scripts that I provide to you rely on a shell script library of common functions (included in the attachment) :
